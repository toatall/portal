...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000000cab2ce7000000001c24a8d1(
...
class phpbbtemplatetwiglexer_000000000cab2ce7000000001c24a8d1 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a58aabce4aa9954588864 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a58aabce4aa9902075950 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a58aabce46c1091134831 = array(
    ...
    {
        $this->initializer5a58aabce4aa9902075950 && ($this->initializer5a58aabce4aa9902075950->__invoke($valueHolder5a58aabce4aa9954588864, $this, 'set_environment', array('env' => $env), $this->initializer5a58aabce4aa9902075950) || 1) && $this->valueHolder5a58aabce4aa9954588864 = $valueHolder5a58aabce4aa9954588864;

        return $this->valueHolder5a58aabce4aa9954588864->set_environment($env);
    }
    ...
    {
        $this->initializer5a58aabce4aa9902075950 && ($this->initializer5a58aabce4aa9902075950->__invoke($valueHolder5a58aabce4aa9954588864, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a58aabce4aa9902075950) || 1) && $this->valueHolder5a58aabce4aa9954588864 = $valueHolder5a58aabce4aa9954588864;

        return $this->valueHolder5a58aabce4aa9954588864->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a58aabce4aa9902075950 && ($this->initializer5a58aabce4aa9902075950->__invoke($valueHolder5a58aabce4aa9954588864, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a58aabce4aa9902075950) || 1) && $this->valueHolder5a58aabce4aa9954588864 = $valueHolder5a58aabce4aa9954588864;

        return $this->valueHolder5a58aabce4aa9954588864->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a58aabce4aa9902075950 = $initializer;
    }
    ...
    {
        $this->initializer5a58aabce4aa9902075950 && ($this->initializer5a58aabce4aa9902075950->__invoke($valueHolder5a58aabce4aa9954588864, $this, '__get', array('name' => $name), $this->initializer5a58aabce4aa9902075950) || 1) && $this->valueHolder5a58aabce4aa9954588864 = $valueHolder5a58aabce4aa9954588864;

        if (isset(self::$publicProperties5a58aabce46c1091134831[$name])) {
            return $this->valueHolder5a58aabce4aa9954588864->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a58aabce4aa9954588864;
    ...
    {
        $this->initializer5a58aabce4aa9902075950 && ($this->initializer5a58aabce4aa9902075950->__invoke($valueHolder5a58aabce4aa9954588864, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a58aabce4aa9902075950) || 1) && $this->valueHolder5a58aabce4aa9954588864 = $valueHolder5a58aabce4aa9954588864;
    ...
    {
        $this->initializer5a58aabce4aa9902075950 && ($this->initializer5a58aabce4aa9902075950->__invoke($valueHolder5a58aabce4aa9954588864, $this, '__isset', array('name' => $name), $this->initializer5a58aabce4aa9902075950) || 1) && $this->valueHolder5a58aabce4aa9954588864 = $valueHolder5a58aabce4aa9954588864;
    ...
    {
        $this->initializer5a58aabce4aa9902075950 && ($this->initializer5a58aabce4aa9902075950->__invoke($valueHolder5a58aabce4aa9954588864, $this, '__unset', array('name' => $name), $this->initializer5a58aabce4aa9902075950) || 1) && $this->valueHolder5a58aabce4aa9954588864 = $valueHolder5a58aabce4aa9954588864;
    ...
    {
        $this->initializer5a58aabce4aa9902075950 && ($this->initializer5a58aabce4aa9902075950->__invoke($valueHolder5a58aabce4aa9954588864, $this, '__clone', array(), $this->initializer5a58aabce4aa9902075950) || 1) && $this->valueHolder5a58aabce4aa9954588864 = $valueHolder5a58aabce4aa9954588864;

        $this->valueHolder5a58aabce4aa9954588864 = clone $this->valueHolder5a58aabce4aa9954588864;
    }

    public function __sleep()
    {
        $this->initializer5a58aabce4aa9902075950 && ($this->initializer5a58aabce4aa9902075950->__invoke($valueHolder5a58aabce4aa9954588864, $this, '__sleep', array(), $this->initializer5a58aabce4aa9902075950) || 1) && $this->valueHolder5a58aabce4aa9954588864 = $valueHolder5a58aabce4aa9954588864;

        return array('valueHolder5a58aabce4aa9954588864');
    }
    ...
    {
        return $this->initializer5a58aabce4aa9902075950;
    }
    ...
    {
        return $this->initializer5a58aabce4aa9902075950 && ($this->initializer5a58aabce4aa9902075950->__invoke($valueHolder5a58aabce4aa9954588864, $this, 'initializeProxy', array(), $this->initializer5a58aabce4aa9902075950) || 1) && $this->valueHolder5a58aabce4aa9954588864 = $valueHolder5a58aabce4aa9954588864;
    }
    ...
    {
        return null !== $this->valueHolder5a58aabce4aa9954588864;
    }
    ...
    {
        return $this->valueHolder5a58aabce4aa9954588864;
    }
