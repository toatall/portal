...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000006ea7aaf7000000002188125f(
...
class phpbbtemplatetwiglexer_000000006ea7aaf7000000002188125f extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a58aae8db3dd696974344 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a58aae8db3dd036664646 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a58aae8db3dd789098681 = array(
    ...
    {
        $this->initializer5a58aae8db3dd036664646 && ($this->initializer5a58aae8db3dd036664646->__invoke($valueHolder5a58aae8db3dd696974344, $this, 'set_environment', array('env' => $env), $this->initializer5a58aae8db3dd036664646) || 1) && $this->valueHolder5a58aae8db3dd696974344 = $valueHolder5a58aae8db3dd696974344;

        return $this->valueHolder5a58aae8db3dd696974344->set_environment($env);
    }
    ...
    {
        $this->initializer5a58aae8db3dd036664646 && ($this->initializer5a58aae8db3dd036664646->__invoke($valueHolder5a58aae8db3dd696974344, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a58aae8db3dd036664646) || 1) && $this->valueHolder5a58aae8db3dd696974344 = $valueHolder5a58aae8db3dd696974344;

        return $this->valueHolder5a58aae8db3dd696974344->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a58aae8db3dd036664646 && ($this->initializer5a58aae8db3dd036664646->__invoke($valueHolder5a58aae8db3dd696974344, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a58aae8db3dd036664646) || 1) && $this->valueHolder5a58aae8db3dd696974344 = $valueHolder5a58aae8db3dd696974344;

        return $this->valueHolder5a58aae8db3dd696974344->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a58aae8db3dd036664646 = $initializer;
    }
    ...
    {
        $this->initializer5a58aae8db3dd036664646 && ($this->initializer5a58aae8db3dd036664646->__invoke($valueHolder5a58aae8db3dd696974344, $this, '__get', array('name' => $name), $this->initializer5a58aae8db3dd036664646) || 1) && $this->valueHolder5a58aae8db3dd696974344 = $valueHolder5a58aae8db3dd696974344;

        if (isset(self::$publicProperties5a58aae8db3dd789098681[$name])) {
            return $this->valueHolder5a58aae8db3dd696974344->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a58aae8db3dd696974344;
    ...
    {
        $this->initializer5a58aae8db3dd036664646 && ($this->initializer5a58aae8db3dd036664646->__invoke($valueHolder5a58aae8db3dd696974344, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a58aae8db3dd036664646) || 1) && $this->valueHolder5a58aae8db3dd696974344 = $valueHolder5a58aae8db3dd696974344;
    ...
    {
        $this->initializer5a58aae8db3dd036664646 && ($this->initializer5a58aae8db3dd036664646->__invoke($valueHolder5a58aae8db3dd696974344, $this, '__isset', array('name' => $name), $this->initializer5a58aae8db3dd036664646) || 1) && $this->valueHolder5a58aae8db3dd696974344 = $valueHolder5a58aae8db3dd696974344;
    ...
    {
        $this->initializer5a58aae8db3dd036664646 && ($this->initializer5a58aae8db3dd036664646->__invoke($valueHolder5a58aae8db3dd696974344, $this, '__unset', array('name' => $name), $this->initializer5a58aae8db3dd036664646) || 1) && $this->valueHolder5a58aae8db3dd696974344 = $valueHolder5a58aae8db3dd696974344;
    ...
    {
        $this->initializer5a58aae8db3dd036664646 && ($this->initializer5a58aae8db3dd036664646->__invoke($valueHolder5a58aae8db3dd696974344, $this, '__clone', array(), $this->initializer5a58aae8db3dd036664646) || 1) && $this->valueHolder5a58aae8db3dd696974344 = $valueHolder5a58aae8db3dd696974344;

        $this->valueHolder5a58aae8db3dd696974344 = clone $this->valueHolder5a58aae8db3dd696974344;
    }

    public function __sleep()
    {
        $this->initializer5a58aae8db3dd036664646 && ($this->initializer5a58aae8db3dd036664646->__invoke($valueHolder5a58aae8db3dd696974344, $this, '__sleep', array(), $this->initializer5a58aae8db3dd036664646) || 1) && $this->valueHolder5a58aae8db3dd696974344 = $valueHolder5a58aae8db3dd696974344;

        return array('valueHolder5a58aae8db3dd696974344');
    }
    ...
    {
        return $this->initializer5a58aae8db3dd036664646;
    }
    ...
    {
        return $this->initializer5a58aae8db3dd036664646 && ($this->initializer5a58aae8db3dd036664646->__invoke($valueHolder5a58aae8db3dd696974344, $this, 'initializeProxy', array(), $this->initializer5a58aae8db3dd036664646) || 1) && $this->valueHolder5a58aae8db3dd696974344 = $valueHolder5a58aae8db3dd696974344;
    }
    ...
    {
        return null !== $this->valueHolder5a58aae8db3dd696974344;
    }
    ...
    {
        return $this->valueHolder5a58aae8db3dd696974344;
    }
