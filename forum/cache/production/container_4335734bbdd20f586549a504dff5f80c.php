...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000678c37050000000017060de3(
...
class phpbbtemplatetwiglexer_00000000678c37050000000017060de3 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a58aad8c2adb795034614 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a58aad8c2adb636423023 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a58aad8c2adb577259026 = array(
    ...
    {
        $this->initializer5a58aad8c2adb636423023 && ($this->initializer5a58aad8c2adb636423023->__invoke($valueHolder5a58aad8c2adb795034614, $this, 'set_environment', array('env' => $env), $this->initializer5a58aad8c2adb636423023) || 1) && $this->valueHolder5a58aad8c2adb795034614 = $valueHolder5a58aad8c2adb795034614;

        return $this->valueHolder5a58aad8c2adb795034614->set_environment($env);
    }
    ...
    {
        $this->initializer5a58aad8c2adb636423023 && ($this->initializer5a58aad8c2adb636423023->__invoke($valueHolder5a58aad8c2adb795034614, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a58aad8c2adb636423023) || 1) && $this->valueHolder5a58aad8c2adb795034614 = $valueHolder5a58aad8c2adb795034614;

        return $this->valueHolder5a58aad8c2adb795034614->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a58aad8c2adb636423023 && ($this->initializer5a58aad8c2adb636423023->__invoke($valueHolder5a58aad8c2adb795034614, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a58aad8c2adb636423023) || 1) && $this->valueHolder5a58aad8c2adb795034614 = $valueHolder5a58aad8c2adb795034614;

        return $this->valueHolder5a58aad8c2adb795034614->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a58aad8c2adb636423023 = $initializer;
    }
    ...
    {
        $this->initializer5a58aad8c2adb636423023 && ($this->initializer5a58aad8c2adb636423023->__invoke($valueHolder5a58aad8c2adb795034614, $this, '__get', array('name' => $name), $this->initializer5a58aad8c2adb636423023) || 1) && $this->valueHolder5a58aad8c2adb795034614 = $valueHolder5a58aad8c2adb795034614;

        if (isset(self::$publicProperties5a58aad8c2adb577259026[$name])) {
            return $this->valueHolder5a58aad8c2adb795034614->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a58aad8c2adb795034614;
    ...
    {
        $this->initializer5a58aad8c2adb636423023 && ($this->initializer5a58aad8c2adb636423023->__invoke($valueHolder5a58aad8c2adb795034614, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a58aad8c2adb636423023) || 1) && $this->valueHolder5a58aad8c2adb795034614 = $valueHolder5a58aad8c2adb795034614;
    ...
    {
        $this->initializer5a58aad8c2adb636423023 && ($this->initializer5a58aad8c2adb636423023->__invoke($valueHolder5a58aad8c2adb795034614, $this, '__isset', array('name' => $name), $this->initializer5a58aad8c2adb636423023) || 1) && $this->valueHolder5a58aad8c2adb795034614 = $valueHolder5a58aad8c2adb795034614;
    ...
    {
        $this->initializer5a58aad8c2adb636423023 && ($this->initializer5a58aad8c2adb636423023->__invoke($valueHolder5a58aad8c2adb795034614, $this, '__unset', array('name' => $name), $this->initializer5a58aad8c2adb636423023) || 1) && $this->valueHolder5a58aad8c2adb795034614 = $valueHolder5a58aad8c2adb795034614;
    ...
    {
        $this->initializer5a58aad8c2adb636423023 && ($this->initializer5a58aad8c2adb636423023->__invoke($valueHolder5a58aad8c2adb795034614, $this, '__clone', array(), $this->initializer5a58aad8c2adb636423023) || 1) && $this->valueHolder5a58aad8c2adb795034614 = $valueHolder5a58aad8c2adb795034614;

        $this->valueHolder5a58aad8c2adb795034614 = clone $this->valueHolder5a58aad8c2adb795034614;
    }

    public function __sleep()
    {
        $this->initializer5a58aad8c2adb636423023 && ($this->initializer5a58aad8c2adb636423023->__invoke($valueHolder5a58aad8c2adb795034614, $this, '__sleep', array(), $this->initializer5a58aad8c2adb636423023) || 1) && $this->valueHolder5a58aad8c2adb795034614 = $valueHolder5a58aad8c2adb795034614;

        return array('valueHolder5a58aad8c2adb795034614');
    }
    ...
    {
        return $this->initializer5a58aad8c2adb636423023;
    }
    ...
    {
        return $this->initializer5a58aad8c2adb636423023 && ($this->initializer5a58aad8c2adb636423023->__invoke($valueHolder5a58aad8c2adb795034614, $this, 'initializeProxy', array(), $this->initializer5a58aad8c2adb636423023) || 1) && $this->valueHolder5a58aad8c2adb795034614 = $valueHolder5a58aad8c2adb795034614;
    }
    ...
    {
        return null !== $this->valueHolder5a58aad8c2adb795034614;
    }
    ...
    {
        return $this->valueHolder5a58aad8c2adb795034614;
    }
