 ...
 * Roles
 * ----------------------------------
 * 1. sezAdmin - роль отдела РНП
 * 2. sezIFNS  - роль сотрудника ИФНС
 * 3. sezUFNS  - роль сотрудника УФНС
 * 
 * @author oleg
 * @version 13.03.2017
 *
...
class DefaultController extends Controller
{
		...
		return array(
			...
			*/
			...
			array(
				...
				'expression'=>function() { return Yii::app()->user->inRole(['admin', 'sezIFNS']); },
			),
	...
	*/
	...
	{		
		$model=new Sez('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Sez']))
			$model->attributes=$_GET['Sez'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='sez-form')
		{
