...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'count_attempt'); ?>
		<?php echo $form->textField($model,'count_attempt'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'count_questions'); ?>
		<?php echo $form->textField($model,'count_questions'); ?>
	</div>
