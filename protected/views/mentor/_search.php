...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'id_mentor_ways'); ?>
		<?php echo $form->textField($model,'id_mentor_ways'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'id_organization'); ?>
		<?php echo $form->textField($model,'id_organization',array('size'=>5,'maxlength'=>5)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'message1'); ?>
		<?php echo $form->textField($model,'message1',array('size'=>-1,'maxlength'=>-1)); ?>
	</div>
