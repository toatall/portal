...
$opts = array(
	...
	'roots' => array(
		array(
			...
			'path'          =>  $pathGenerator->rootPath . $pathGenerator->pathImage,                 // path to files (REQUIRED)
			'URL'           =>  $pathGenerator->rootUrl . $pathGenerator->pathImage, // URL to files (REQUIRED)			
			'unloadDeny' => array('all'),
